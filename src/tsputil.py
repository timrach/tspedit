...
def solveTSP(filename, callback):
    """ Calls the extern concorde program to solve the problem represented
        in the given file. Then parses the solution and
        deletes all files generated by concorde."""

    #Check operating system first
    sysos = platform.system()
    #and call the corresponding binary of concorde
    if sysos == "Darwin": subprocess.call(["..bin/concorde-osx", filename]) 
    elif sysos == "Linux": subprocess.call(["../bin/concorde-fedora", filename])
    elif sysos == "Windows": return #this function is not supported under windows yet
    else: return
